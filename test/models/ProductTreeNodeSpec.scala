...
class ProductTreeNodeSpec extends BaseSpec {
  ...
  "Calling ProductTreeLeaf.getDisplayWeight" should {
    ...
    "return the correct display weight" in {
      ...
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("tobacco/cigars"), "iid0", Some(1.54332), Some(50), Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
  ...
  "Calling ProductTreeLeaf.getDescription" should {
    ...
    "return the correct display description for tobacco" in {
      ...
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("tobacco/chewing"), "iid0", Some(1.54332), None, Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
      productTreeLeaf.isValid(purchasedProductInstance) shouldBe true
    ...
    "return the correct display description for alcohol" in {
      ...
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("alcohol/beer"), "iid0", Some(1.54332), None, Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
      productTreeLeaf.isValid(purchasedProductInstance) shouldBe true
    ...
    "return the correct display description for other-goods" in {
      ...
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("other-goods/childrens"), "iid0", Some(1.54332), None, Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
      productTreeLeaf.isValid(purchasedProductInstance) shouldBe true
    ...
    "return the correct display description for cigarettes" in {
      ...
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("tobacco/cigarettes"), "iid0", Some(1.54332), Some(20), Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
      productTreeLeaf.isValid(purchasedProductInstance) shouldBe true
    ...
    "return the correct display description for cigars" in {
      ...
      val productTreeLeaf = ProductTreeLeaf("cigars", "Cigars", "TOB/A1/CIGAR", "cigars")
      val purchasedProductInstance = PurchasedProductInstance(ProductPath("tobacco/cigars"),"iid0", Some(1.54332), Some(5), Some("Egypt"), Some("AUD"), Some(BigDecimal(10.234)))
      productTreeLeaf.isValid(purchasedProductInstance) shouldBe true
