...
class VapingProductsInputViewSpec extends BaseViewSpec {

  private val productPath: ProductPath = ProductPath(path = "vaping-products/vape")
  ...
  private val emptyForm: Form[VapeDto] = injected[VapingProductsInputForm]
    .vapingProductsForm(productPath)
    .bind(
      Map(
        "weightOrVolume" -> "",
        "country"        -> "",
  ...
  private val emptyCountryForm: Form[VapeDto] = injected[VapingProductsInputForm]
    .vapingProductsForm(productPath)
    .bind(
      Map(
        "weightOrVolume" -> "90",
  ...
  private val emptyVolumeForm: Form[VapeDto] = injected[VapingProductsInputForm]
    .vapingProductsForm(productPath)
    .bind(
      Map(
        "weightOrVolume" -> "",
  ...
  private val emptyPriceForm: Form[VapeDto] = injected[VapingProductsInputForm]
    .vapingProductsForm(productPath)
    .bind(
      Map(
        "weightOrVolume" -> "90",
  ...
  private val validForm: Form[VapeDto] = injected[VapingProductsInputForm]
    .vapingProductsForm(productPath)
    .bind(
      Map(
        "weightOrVolume" -> "90",
  ...
  val viewViaApply: HtmlFormat.Appendable = injected[vaping_products_input].apply(
    form = validForm,
    backLink = None,
  ...
  val viewViaRender: HtmlFormat.Appendable = injected[vaping_products_input].render(
    form = validForm,
    backLink = None,
    customBackLink = false,
    path = productPath,
  ...
  val viewViaF: HtmlFormat.Appendable = injected[vaping_products_input].ref.f(
    validForm,
    None,
    false,
    productPath,
  ...
  val euOnlyView: HtmlFormat.Appendable = injected[vaping_products_input].apply(
    form = validForm,
    backLink = None,
    customBackLink = false,
    path = productPath,
  ...
  val noIidView: HtmlFormat.Appendable = injected[vaping_products_input].apply(
    form = validForm,
    backLink = None,
    customBackLink = false,
    path = productPath,
  ...
  private def buildView(form: Form[VapeDto]): HtmlFormat.Appendable =
    injected[vaping_products_input].apply(
      form = form,
      backLink = None,
      customBackLink = false,
      path = productPath,
  ...
  val expectedEmptyFormErrors: Seq[(String, String)] = List(
    "#weightOrVolume" -> messages("error.required.volume.vaping-products.vape"),
    "#country"        -> messages("error.country.invalid"),
    "#currency"       -> messages("error.currency.invalid"),
    "#cost"           -> messages("error.required.vaping-products.vape")
  )
  ...
  val invalidTestCases: Seq[(String, Form[VapeDto], Seq[(String, String)])] = Seq(
  ...
  "VapingProductsInputView" when {
    renderViewTest(
      title = "Tell us about the vaping products - Check tax on goods you bring into the UK - GOV.UK",
      heading = "Tell us about the Vaping Products"
    )
