...
class DeclarationServiceSpec extends BaseSpec with ScalaFutures {
  ...
  private trait CMASetup {
    ...
    when(mockServicesConfig.getString("declarations.greatBritain")).thenReturn("Great Britain")
    when(mockServicesConfig.getString("declarations.telephonePrefix")).thenReturn("XPASSID")
    when(mockAppConfig.CMAEnabled).thenReturn(true)
  ...
  "If isCMAEnabled is true" should {
    "Calling DeclarationService.submitDeclaration" should {
      ...
      "return a DeclarationServiceFailureResponse if the backend returns 400" in new CMASetup with EndpointSetup {
        ...
        val ui: UserInformation =
          userInformation.copy(identificationType = "passport", identificationNumber = "SX12345")
      ...
      "return a DeclarationServiceFailureResponse if the backend returns 500" in new CMASetup with EndpointSetup {
      ...
      "return a DeclarationServiceSuccessResponse if the backend returns 202" in new CMASetup with EndpointSetup {
    ...
    "Calling DeclarationService.buildPartialDeclarationMessage" should {
      ...
      "truncate a product description to 40 characters if the product description is too big in the metadata." in new CMASetup {
      ...
      "generate the correct payload and set euCountryCheck is nonEuOnly and arrivingNI flag is true" in new CMASetup {
      ...
      "generate the correct payload and adhere to the schema when journeyData a calculation with all product categories in" in new CMASetup {
      ...
      "generate the correct payload and including ukVATPaid, ukExcisePaid, uccRelief, isMade and eu flags at item level" in new CMASetup {
      ...
      "format the idValue if idType is telephone and generate the correct payload GBNI journey in " in new CMASetup {
      ...
      "format the idValue to uppercase if idType is telephone and contains lowercase characters in " in new CMASetup {
      ...
      "format the idValue to uppercase if idType is not telephone and contains lowercase characters in " in new CMASetup {
      ...
      "generate correct acknowledgment reference number for amendment" in new CMASetup {
    ...
    "Calling DeclarationService.storeChargeReference" should {
      ...
      "store charge reference information" in new CMASetup {
    ...
    "Calling DeclarationService.updateDeclaration" should {
      ...
      "return a DeclarationServiceFailureResponse for update if the declaration returns 500" in new CMASetup
        with EndpointSetup {
      ...
      "return a DeclarationServiceFailureResponse for update if declaration returns a bad request" in new CMASetup
        with EndpointSetup {
      ...
      "return a DeclarationServiceFailureResponse for update if the declaration is not found" in new CMASetup
        with EndpointSetup {
      ...
      "return a DeclarationServiceSuccessResponse for update if the declaration returns 202" in new CMASetup
        with EndpointSetup {
    ...
    "Calling DeclarationService.retrieveDeclaration" should {
      ...
      "return a DeclarationServiceFailureResponse if the backend returns 400" in new CMASetup with EndpointSetup {
        ...
        val r: DeclarationServiceResponse =
          declarationService.retrieveDeclaration(previousDeclarationRequest).futureValue
      ...
      "return a DeclarationServiceFailureResponse if the backend returns NOT FOUND" in new CMASetup with EndpointSetup {
      ...
      "return a DeclarationServiceSuccessResponse if the backend returns 200" in new CMASetup with EndpointSetup {
      ...
      "return a DeclarationServiceSuccessResponse with amend state and delta calculation if the backend returns 200" in new CMASetup
        with EndpointSetup {

        override def journeyDataInCache: Option[JourneyData] = None

        override def httpResponse: HttpResponse =
          HttpResponse.apply(OK, expectedJsonWithDeltaCalcAndAmendState.toString)
  ...
  "If isCMAEnabled is false" should {
    "Calling DeclarationService.submitDeclaration" should {
