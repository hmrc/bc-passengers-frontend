...
class NewPurchaseServiceSpec extends BaseSpec {
  ...
  "Calling NewPurchaseService.insertPurchases" should {
    ...
    "add purchases to existing journey data" in new LocalSetup {
      ...
      val modifiedJourneyData = s.insertPurchases(ProductPath("some/item/path"), Some(185.5), Some(100), "FR", "EUR", List(12.50), new Random(1))(localContext)._1
    ...
    "set default country and currency in journey data" in new LocalSetup{
      ...
      val modifiedJourneyData = s.insertPurchases(ProductPath("some/item/path"), Some(185.5), Some(100), "FR", "EUR", List(12.50, 13.60, 14.70), new Random(1))(localContext)._1
