...
class PortsOfArrivalServiceSpec extends BaseSpec {
  ...
  private val expectedPorts: List[PortsOfArrival] = List(
    ...
    PortsOfArrival("FOL", "title.folkestone", isGB=true, List("Cheriton", "Folkestone", "Eurotunnel", "Channel Tunnel")),
    ...
    PortsOfArrival("INV", "title.inverness_port", isGB=true,Nil),
    ...
    PortsOfArrival("IOM", "title.isle_of_man_sea_airport", isGB=true, List("Douglas")),
    ...
    PortsOfArrival("PED", "title.pembroke_docks", isGB=true, Nil),
    ...
    PortsOfArrival("STN", "title.port_of_southampton", isGB=true, List("Southampton Port")),
    ...
    PortsOfArrival("MME", "title.teeside_international_airport", isGB=true, List("Durham Tees Valley Airport", "MME")),
