...
class CalculatorServiceSpec extends BaseSpec {
  ...
  "Calling CalculatorService.journeyDataToCalculatorRequest" should {
    ...
    val calcRequest = CalculatorRequest(isPrivateCraft = false, isAgeOver17 = true, isVatResClaimed = None, List(
      PurchasedItem(PurchasedProductInstance(ProductPath("other-goods/car-seats"),"iid0",None,None,Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("AUD"),Some(74563)),ProductTreeLeaf("car-seats","Children’s car seats","OGD/MOB/MISC","other-goods", Nil),Currency("AUD","title.australian_dollars_aud",Some("AUD"), List("Australian", "Oz")), BigDecimal(74563/1.76).setScale(2, RoundingMode.DOWN), ExchangeRate("1.76", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("other-goods/antiques"),"iid0",None,None,Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("AUD"),Some(33)),ProductTreeLeaf("antiques","Antiques, collector’s pieces and works of art","OGD/ART","other-goods", Nil),Currency("AUD","title.australian_dollars_aud",Some("AUD"), List("Australian", "Oz")), BigDecimal(33/1.76).setScale(2, RoundingMode.DOWN), ExchangeRate("1.76", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("other-goods/antiques"),"iid1",None,None,Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("CHF"),Some(5432)),ProductTreeLeaf("antiques","Antiques, collector’s pieces and works of art","OGD/ART","other-goods", Nil),Currency("CHF","title.swiss_francs_chf",Some("CHF"), List("Swiss", "Switzerland")), BigDecimal(5432/1.26).setScale(2, RoundingMode.DOWN), ExchangeRate("1.26", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("tobacco/chewing-tobacco"),"iid0",Some(45),None,Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("CHF"),Some(43)),ProductTreeLeaf("chewing-tobacco","Pipe or chewing tobacco","TOB/A1/OTHER","tobacco", List("L-LOOSE")),Currency("CHF","title.swiss_francs_chf",Some("CHF"), List("Swiss", "Switzerland")), BigDecimal(43/1.26).setScale(2, RoundingMode.DOWN), ExchangeRate("1.26", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("tobacco/cigars"),"iid0",Some(40),Some(20),Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("AUD"),Some(1234)),ProductTreeLeaf("cigars","Cigars","TOB/A1/CIGAR","cigars", List("L-CIGAR")),Currency("AUD","title.australian_dollars_aud",Some("AUD"), List("Australian", "Oz")), BigDecimal(1234/1.76).setScale(2, RoundingMode.DOWN), ExchangeRate("1.76", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("tobacco/cigarettes"),"iid0",None,Some(200),Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("GBP"),Some(60)),ProductTreeLeaf("cigarettes","Cigarettes","TOB/A1/CIGRT","cigarettes", List("L-CIGRT")),Currency("GBP","title.british_pounds_gbp",None, List("England", "Scotland", "Wales", "Northern Ireland", "British", "sterling", "pound", "GB")), BigDecimal(60).setScale(2, RoundingMode.DOWN), ExchangeRate("1.00", todaysDate)),
      PurchasedItem(PurchasedProductInstance(ProductPath("alcohol/beer"),"iid0",Some(12),None,Some(Country("EG", "title.egypt", "EG", isEu = false, Nil)),Some("GGP"),Some(123)),ProductTreeLeaf("beer","Beer","ALC/A2/BEER","alcohol", List("L-BEER")),Currency("GGP","title.guernsey_pounds_ggp",None, List("Channel Islands")), BigDecimal(123).setScale(2, RoundingMode.DOWN), ExchangeRate("1.00", todaysDate))
    ))
