...
class CountriesServiceSpec extends UnitSpec {
  ...
  val expectedCountries = List(
    ...
    Country("Antigua and Barbuda", "AG", isEu = false, Some("USD")),
    Country("Argentina", "AQ", isEu = false, Some("ARS")),
    ...
    Country("Cayman Islands (the)", "KY", isEu = false, Some("CLP")),
    ...
    Country("Comoros (the)", "KM", isEu = false, Some("KOF")),
    ...
    Country("Croatia", "HR", isEu = true, Some("HKR")),
    Country("Cuba", "CU", isEu = false, Some("CUP")),
    Country("Curaçao", "CW", isEu = false, None),
    Country("Cyprus", "CW", isEu = true, Some("EUR")),
    Country("Czechia", "CW", isEu = true, Some("CZK")),
    ...
    Country("Malta", "ML", isEu = true, Some("EUR")),
    ...
    Country("Morocco", "MA", isEu = false, Some("MAC")),
    ...
    Country("United Kingdom of Great Britain and Northern Ireland (the)", "GB", isEu = true, Some("GBP")),
