  ...
  "Calling POST /products/other-goods/.../cost/iid0" should {
    ...
    "store the cost, move the working product to purchased products and redirect to the currency page passing ir = 1 when items remaining was 2 and given valid form input" in new LocalSetup {
      ...
      override lazy val cachedJourneyData: Option[JourneyData]= Some(requiredJourneyData.copy(workingInstance =
        Some(PurchasedProductInstance(ProductPath("other-goods/books"), iid = "iid0", currency = Some("USD"), country = Some(Country("USA", "US", false, Some("USA")))))))
      ...
      verify(injected[LocalSessionCache], times(1)).cacheJourneyData(meq(requiredJourneyData.copy(purchasedProductInstances =
        List(PurchasedProductInstance(ProductPath("other-goods/books"), "iid0", currency = Some("USD"), country = Some(Country("USA", "US", false, Some("USA"))), cost = Some(BigDecimal("2.99")))))))(any())
    ...
    "store the cost, replace the working product in purchased products if it already existed and redirect to the next step when items remaining was 1 and given valid form input" in new LocalSetup {
      ...
      override lazy val limitUsageResponse = LimitUsageSuccessResponse(Map.empty)
      override lazy val cachedJourneyData: Option[JourneyData]= Some(requiredJourneyData.copy(
        purchasedProductInstances = List(PurchasedProductInstance(ProductPath("other-goods/books"), "iid0", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA"))))),
        workingInstance = Some(PurchasedProductInstance(ProductPath("other-goods/books"), iid = "iid0", currency = Some("USD"), country = Some(Country("USA", "US", false, Some("USA")))))
      ))
      val result = route(app, EnhancedFakeRequest("POST", "/check-tax-on-goods-you-bring-into-the-uk/products/other-goods/books/cost/iid0").withFormUrlEncodedBody("cost" -> "2.99", "itemsRemaining" -> "1")).get
      ...
      verify(injected[LocalSessionCache], times(1)).fetchAndGetJourneyData(any())
      verify(injected[LocalSessionCache], times(1)).cacheJourneyData(meq(requiredJourneyData.copy(purchasedProductInstances =
        List(PurchasedProductInstance(ProductPath("other-goods/books"), "iid0", currency = Some("USD"), cost = Some(BigDecimal("2.99")), country = Some(Country("USA", "US", false, Some("USA"))))))))(any())
    ...
    "store the cost, replace the working product in purchased products (maintaining order) if it already existed and redirect to the next step when items remaining was 1 and given valid form input" in new LocalSetup {
      ...
      override lazy val cachedJourneyData: Option[JourneyData]= Some(requiredJourneyData.copy(
        purchasedProductInstances = List(
          PurchasedProductInstance(ProductPath("other-goods/books"), "iid0", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA")))),
          PurchasedProductInstance(ProductPath("other-goods/books"), "iid1", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA")))),
          PurchasedProductInstance(ProductPath("other-goods/books"), "iid2", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA"))))
        ),
        workingInstance = Some(PurchasedProductInstance(ProductPath("other-goods/books"), iid = "iid1", currency = Some("USD"), country = Some(Country("USA", "US", false, Some("USA")))))
      ))
      ...
      verify(injected[LocalSessionCache], times(1)).cacheJourneyData(meq(requiredJourneyData.copy(purchasedProductInstances = List(
        PurchasedProductInstance(ProductPath("other-goods/books"), "iid0", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA")))),
        PurchasedProductInstance(ProductPath("other-goods/books"), "iid1", currency = Some("USD"), cost = Some(BigDecimal("2.99")), country = Some(Country("USA", "US", false, Some("USA")))),
        PurchasedProductInstance(ProductPath("other-goods/books"), "iid2", currency = Some("USD"), cost = Some(BigDecimal("0.99")), country = Some(Country("USA", "US", false, Some("USA"))))
      ))))(any())
