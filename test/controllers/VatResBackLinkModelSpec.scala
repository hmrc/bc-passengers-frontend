...
class VatResBackLinkModelSpec extends BaseSpec {
  ...
  trait LocalSetup {
    ...
    lazy val context = new LocalContext(FakeRequest(call), "FAKESESSIONIN", journeyData)
  }
  ...
  "Going back from private-travel" should {
    ...
    "return user to goods-bought-inside-and-outside-eu when euCountryCheck=both and isVatResClaimed=false and bringingDutyFree=false and bringingOverAllowance = true" in new LocalSetup {
      override val euCountryCheck  = Some("both")
      override val isVatResClaimed = Some(false)
      override val bringingDutyFree = Some(false)
    ...
    "return user to no-need-to-use-this-service when euCountryCheck=both and isVatResClaimed=false and bringingDutyFree=false and bringingOverAllowance = false" in new LocalSetup {
      override val euCountryCheck  = Some("both")
      override val isVatResClaimed = Some(false)
      override val bringingDutyFree = Some(false)
    ...
    "return user to duty-free-mix when euCountryCheck=both and isVatResClaimed=false and bringingDutyFree=true and bringingOverAllowance=true" in new LocalSetup {
      override val euCountryCheck  = Some("both")
      override val isVatResClaimed = Some(false)
      override val bringingDutyFree = Some(true)
      override val bringingOverAllowance = Some(true)
    ...
    "return user to no-need-to-use-this-service when euCountryCheck=both and isVatResClaimed=false and bringingDutyFree=true and bringingOverAllowance=false" in new LocalSetup {
      override val euCountryCheck  = Some("both")
      override val isVatResClaimed = Some(false)
      override val bringingDutyFree = Some(true)
      override val bringingOverAllowance = Some(false)
  ...
  "Going back from no-need-to-use-service" should {
    ...
    "return user to duty-free-mix when euCountryCheck=both and bringingDutyFree=true" in new LocalSetup {
      override val euCountryCheck = Some("both")
      override val isVatResClaimed = None
      override val bringingDutyFree = Some(true)
      override val bringingOverAllowance = None
