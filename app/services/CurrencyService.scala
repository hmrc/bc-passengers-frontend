...
class CurrencyService {
  ...
  val currencies = List(
    Currency("AED", "United Arab Emirates dirham (AED)", Some("AED"), List("UAE", "United Arab Emirates", "Emirati", "Arab", "United", "Emirates", "dubai", "abu dahbi")),
    ...
    Currency("PHP", "Philippineno pesos (PHP)", Some("PHP"), List("Philippenes")),
    ...
    Currency("RUB", "Russian roubles (RUB)", Some("RUB"), List("USSR")),
    ...
    Currency("SZL", "Swaziland lilangeni (SZL)", Some("SZL"), Nil),
    ...
    Currency("XAF", "Central African francs (XAF)", Some("XAF"), List("Central Africa franc", "Cameroon", "Chad", "Congo", "Equatorial Guinea", "Gabon")),
    Currency("XCD", "East Caribbean dollars (XCD)", Some("XCD"), List("East Caribbean dollars", "Dominica", "Grenada", "Montserrat", "St Christopher and Anguilla", "Saint Christopher", "St Lucia", "Saint Lucia", "St Vincent", "Saint Vincent")),
    Currency("XOF", "West African francs (XOF)", Some("XOF"), List("West African franc", "Benin", "Burkina Faso", "Cote d'Ivoire", "Ivory Coast", "Guinea Bissau", "Mali", "Niger", "Senegal", "Togo")),
    Currency("XPF", "CFP francs (XPF)", Some("XPF"), List("CFP franc", "Fr. Polynesia", "French Polynesia", "New Caledonia", "Wallis and Futuna Islands")),
