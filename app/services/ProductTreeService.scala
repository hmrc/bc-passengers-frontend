...
class ProductTreeService {
          ...
          List(
            ...
            ProductTreeBranch(
              ...
              List(
                ProductTreeLeaf(
                  "non-sparkling-cider",
                  "label.alcohol.cider.non-sparkling-cider",
                  "ALC/A1/CIDER",
                  "alcohol",
                  List("L-ALCOTH")
                ),
                ProductTreeLeaf(
                  "sparkling-cider",
                  "label.alcohol.cider.sparkling-cider",
                  "ALC/A1/CIDERU5SP",
                  "alcohol",
                  List("L-ALCOTH")
                ),
                ProductTreeLeaf(
                  "sparkling-cider-up",
                  "label.alcohol.cider.sparkling-cider-up",
                  "ALC/A1/CIDERU8SP",
                  "alcohol",
                  List("L-ALCOTH")
                )
            ...
            ProductTreeLeaf(
              "sparkling-wine",
              "label.alcohol.sparkling-wine",
              "ALC/A1/WINESP",
              "alcohol",
              List("L-WINE", "L-WINESP")
            ),
  ...
  val otherGoodsSearchItems: List[OtherGoodsSearchItem] = List(
    ...
    OtherGoodsSearchItem(
      "label.other-goods.childrens.childrens-clothing",
      ProductPath("other-goods/childrens/childrens-clothing")
    ),
    OtherGoodsSearchItem(
      "label.other-goods.childrens.childrens-footwear",
      ProductPath("other-goods/childrens/childrens-footwear")
    ),
    ...
    OtherGoodsSearchItem(
      "label.other-goods.electronic-devices.televisions",
      ProductPath("other-goods/electronic-devices/televisions")
    ),
    ...
    OtherGoodsSearchItem(
      "label.other-goods.electronic-devices.other",
      ProductPath("other-goods/electronic-devices/other")
    ),
