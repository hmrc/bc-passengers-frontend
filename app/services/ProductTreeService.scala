...
class ProductTreeService {
  ...
  val otherGoodsSearchItems: List[OtherGoodsSearchItem] = List(
    ...
    OtherGoodsSearchItem("label.other-goods.adult.adult-clothing", ProductPath("other-goods/adult/adult-clothing")),
    ...
    OtherGoodsSearchItem("label.other-goods.adult.adult-footwear", ProductPath("other-goods/adult/adult-footwear")),
    ...
    OtherGoodsSearchItem("label.other-goods.smart_watch", ProductPath("other-goods/watches-clocks")),
    ...
    OtherGoodsSearchItem("label.other-goods.childrens.childrens-clothing", ProductPath("other-goods/childrens/childrens-clothing")),
    OtherGoodsSearchItem("label.other-goods.childrens.childrens-footwear", ProductPath("other-goods/childrens/childrens-footwear")),
    ...
    OtherGoodsSearchItem("label.other-goods.smart_phone", ProductPath("other-goods/electronic-devices/other")),
    ...
    OtherGoodsSearchItem("label.other-goods.e-reader", ProductPath("other-goods/electronic-devices/other")),
    ...
    OtherGoodsSearchItem("label.other-goods.electronic-devices.televisions", ProductPath("other-goods/electronic-devices/televisions")),
    ...
    OtherGoodsSearchItem("label.other-goods.furniture", ProductPath("other-goods/furniture")),
    OtherGoodsSearchItem("label.other-goods.books", ProductPath("other-goods/books")),
    OtherGoodsSearchItem("label.other-goods.carpets-fabric.carpets", ProductPath("other-goods/carpets-fabric/carpets")),
    OtherGoodsSearchItem("label.other-goods.carpets-fabric.fabrics", ProductPath("other-goods/carpets-fabric/fabrics")),
    OtherGoodsSearchItem("label.other-goods.car-seats", ProductPath("other-goods/car-seats")),
    OtherGoodsSearchItem("label.other-goods.disability-equipment", ProductPath("other-goods/disability-equipment")),
    OtherGoodsSearchItem("label.other-goods.electronic-devices.other", ProductPath("other-goods/electronic-devices/other")),
    OtherGoodsSearchItem("label.other-goods.glassware", ProductPath("other-goods/glassware")),
    OtherGoodsSearchItem("label.other-goods.mobility-aids", ProductPath("other-goods/mobility-aids")),
    OtherGoodsSearchItem("label.other-goods.perfumes-cosmetics", ProductPath("other-goods/perfumes-cosmetics")),
    OtherGoodsSearchItem("label.other-goods.protective-helmets", ProductPath("other-goods/protective-helmets")),
    OtherGoodsSearchItem("label.other-goods.sanitary-products", ProductPath("other-goods/sanitary-products")),
