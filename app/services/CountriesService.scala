...
class CountriesService {
  ...
  private val countries = List(
    ...
    Country("CN", "title.china", "CN", isEu=false, isCountry=true, List("People's Republic of China", "PRC", "Peoples Republic of China")),
    ...
    Country("CD", "title.democratic_republic_of_the_congo", "CD", isEu=false, isCountry=true, List("DR Congo", "DRC")),
    Country("CG", "title.republic_of_the_congo", "CG", isEu=false, isCountry=true, List("Congo-Brazzaville", "Congo Republic")),
    ...
    Country("CI", "title.cote_divoire", "CI", isEu=false, isCountry=true, List("Ivory Coast", "Cote d'Ivoire", "Cote dIvoire", "Cote d Ivoire")),
    ...
    Country("PH", "title.philippines", "PH", isEu=false, isCountry=true, List("Philippenes", "Phillipines", "Phillippines", "Philipines")),
    ...
    Country("SH", "title.saint_helena_ascension_and_tristan_da_cunha", "SH", isEu=false, isCountry=true, List("St Helena")),
    ...
    Country("TG", "title.togo", "TG", isEu=false, isCountry=true, List("Togo Republic", "Togolese Republic", "Republic of Togo")),
    ...
    Country("AE", "title.united_arab_emirates", "AE", isEu=false, isCountry=true, List("UAE", "emirati", "dubai", "abu dahbi", "abu dhabi")),
    Country("GB", "title.united_kingdom", "GB", isEu=false, isCountry=true, List("England", "Scotland", "Wales", "Northern Ireland", "GB", "UK")),
    Country("UM", "title.united_states_minor_outlying_islands", "UM", isEu=false, isCountry=true, Nil),
    Country("US", "title.united_states_of_america", "US", isEu=false, isCountry=true, List("USA", "US", "American")),
