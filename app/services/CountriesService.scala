...
class CountriesService {
  ...
  private val countries = List(
    ...
    Country("BN", "title.brunei", "BN", isEu=false, Nil),
    ...
    Country("VA", "title.holy_see", "VA", isEu=false, List("Vatican City")),
    ...
    Country("KO", "title.kosovo", "KO", isEu=false, Nil),
    ...
    Country("LA", "title.laos", "LA", isEu=false, List("Lao Peoples Democratic Republic")),
    ...
    Country("MK", "title.north_macedonia", "MK", isEu=false, Nil),
    ...
    Country("MM", "title.myanmar", "MM", isEu=false, List("Burma")),
    ...
    Country("RU", "title.russia", "RU", isEu=false, List("USSR", "Soviet Union")),
    ...
    Country("ZA", "title.south_africa", "ZA", isEu=false, List("RSA")),
    ...
    Country("VN", "title.vietnam", "VN", isEu=false, Nil),
