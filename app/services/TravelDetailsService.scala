...
class TravelDetailsService @Inject() (
  ...
  def storeEuCountryCheck(
    journeyData: Option[JourneyData]
  )(countryChoice: String)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeVatResCheck(
    journeyData: Option[JourneyData]
  )(isVatResClaimed: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeBringingDutyFree(
    journeyData: Option[JourneyData]
  )(isBringingDutyFree: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeBringingOverAllowance(
    journeyData: Option[JourneyData]
  )(bringingOverAllowance: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storePrivateCraft(
    journeyData: Option[JourneyData]
  )(privateCraft: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeAgeOver17(
    journeyData: Option[JourneyData]
  )(ageOver17: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeIrishBorder(
    journeyData: Option[JourneyData]
  )(irishBorder: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeArrivingNI(
    journeyData: Option[JourneyData]
  )(arrivingNICheck: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeUKVatPaid(
    journeyData: Option[JourneyData]
  )(isUKVatPaid: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeUKExcisePaid(
    journeyData: Option[JourneyData]
  )(isUKVatExcisePaid: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
  ...
  def storeUccRelief(
    journeyData: Option[JourneyData]
  )(isUccRelief: Boolean)(implicit hc: HeaderCarrier): Future[Option[JourneyData]] =
    journeyData match {
