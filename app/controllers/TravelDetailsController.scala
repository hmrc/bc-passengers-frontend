...
class TravelDetailsController @Inject() (
  ...
  whereGoodsBoughtEnforcer: WhereGoodsBoughtEnforcer,
  didYouClaimTaxBackEnforcer: DidYouClaimTaxBackEnforcer,
  bringingDutyFreeEnforcer: BringingDutyFreeEnforcer,
  goodsBoughtInsideEuEnforcer: GoodsBoughtInsideEuEnforcer,
  goodsBoughtOutsideEuEnforcer: GoodsBoughtOutsideEuEnforcer,
  goodsBoughtInAndOutEuEnforcer: GoodsBoughtInAndOutEuEnforcer,
  noNeedToUseServiceEnforcer: NoNeedToUseServiceEnforcer,
  declareDutyFreeAnyEnforcer: DeclareDutyFreeAnyEnforcer,
  declareDutyFreeEuEnforcer: DeclareDutyFreeEuEnforcer,
  declareDutyFreeMixEnforcer: DeclareDutyFreeMixEnforcer,
  privateCraftEnforcer: PrivateCraftEnforcer,
  is17OrOverEnforcer: Is17OrOverEnforcer,
