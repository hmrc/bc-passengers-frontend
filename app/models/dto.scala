...
object EmailAddressDto extends Validators {
  ...
  private def emailAddressMatchConstraint(): Constraint[EmailAddressDto] =
    Constraint { model =>
  ...
  def form: Form[EmailAddressDto] = Form(
    ...
    )(EmailAddressDto.apply)(EmailAddressDto.unapply)
...
//      DateTimeOfArrival(
//        formatLocalDate(userInformation.dateOfArrival, "dd-MM-yyyy"),//TODO THIS IS IMPORTANT
//        formatLocalTime(userInformation.timeOfArrival).toLowerCase//TODO THIS IS IMPORTANT
//      )
//    )
//
//}
